...
(function () {
  ...
  var messages = {
    ko: {
      ...
      childPosts: "하위 글",
      toc: "목차", private: "비공개", noteMeta: "노트 {count}편 · 분류 {categories}개",
      postCount: "글 {count}건", noCategories: "카테고리가 없다.",
      notFoundTitle: "여기에는 아무것도 없습니다",
      notFoundLead: "주소가 바뀌었거나, 아직 공개하지 않은 글일 수 있습니다.",
      serverErrorTitle: "서버가 이 요청을 끝내지 못했습니다",
      serverErrorLead: "잠시 뒤에 다시 열어보세요. 문제는 기록에 남았습니다.",
      backHome: "홈으로 돌아가기",
      brandHead: "열렬히", brandTail: "뛰기",
      personalSite: "최인렬의 개인 페이지",
      login: "로그인", logout: "로그아웃", newPost: "새 글", edit: "편집",
      homeKicker: "기술 블로그 겸 학습 아카이브", recentPosts: "최근에 쓴 글",
    ...
    en: {
      ...
      toc: "Contents", private: "Private", noteMeta: "{count} notes · {categories} categories",
      postCount: "{count} posts", noCategories: "No categories.",
      notFoundTitle: "There is nothing here",
      notFoundLead: "The address may have changed, or the post is not published yet.",
      serverErrorTitle: "The server could not finish this request",
      serverErrorLead: "Please try again in a moment. The problem has been logged.",
      backHome: "Back to home",
      brandHead: "Real", brandTail: "Leaner",
      personalSite: "Inryeol Choi's personal site",
      login: "Sign in", logout: "Sign out", newPost: "New post", edit: "Edit",
      homeKicker: "Engineering notes & learning archive", recentPosts: "Recently written",
    ...
    es: {
      ...
      toc: "Contenido", private: "Privado", noteMeta: "{count} notas · {categories} categorías",
      postCount: "{count} artículos", noCategories: "No hay categorías.",
      notFoundTitle: "Aquí no hay nada",
      notFoundLead: "La dirección puede haber cambiado o el artículo aún no está publicado.",
      serverErrorTitle: "El servidor no pudo completar esta solicitud",
      serverErrorLead: "Inténtelo de nuevo en unos momentos. El problema quedó registrado.",
      backHome: "Volver al inicio",
      brandHead: "Real", brandTail: "Leaner",
      personalSite: "Sitio personal de Inryeol Choi",
      login: "Entrar", logout: "Salir", newPost: "Nueva entrada", edit: "Editar",
      homeKicker: "Notas de ingeniería y archivo de aprendizaje", recentPosts: "Escrito recientemente",
